...
import { LayoutMt60, Title, TextDesc } from "../components/GlobalElement";
  ...
  return (
    <div>
      ...
      <LayoutMt60>
        ...
        <TextDesc>
          Privacy Policy of stellar power house stellar power house operates the
          gostellar.id website, which provides the SERVICE. This page is used to
          inform website visitors regarding our policies with the collection,
          use, and disclosure of Personal Information if anyone decided to use
          our Service, gostellar.id. If you choose to use our Service, then you
        ...
        <TextDesc>
          ...
          and we cannot guarantee its absolute security. Links to Other Sites
