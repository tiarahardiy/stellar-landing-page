...
export const HeroLoc = styled.div `
    background: linear-gradient(0deg, rgba(0, 0, 0, 0.32), rgba(0, 0, 0, 0.32)), url(${HeroBgImg});
    display: flex;
...
export const LocLayout = styled.div `
    background: linear-gradient(0deg, rgba(0, 0, 0, 0.48), rgba(0, 0, 0, 0.48)), url(${HeroBgImg});
    background-position: center;
    background-repeat: no-repeat;
    background-size: cover;
    position: relative;
